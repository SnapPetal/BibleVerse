...
export interface CfnLocationObjectStorageProps {
    ...
    readonly subdirectory?: string;
    /**
     * Specifies the key-value pair that represents the tag to help you manage, filter, and search for your location. We recommend using tags for naming your locations.
     *
